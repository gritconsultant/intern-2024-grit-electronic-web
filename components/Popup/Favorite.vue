<template>
    ...
    >
      <div class="flex justify-between items-center p-5 border-b-2">
        ...
        <h2 @click="clearFavorites" class="text-red-500 cursor-pointer ml-28">
          ลบทั้งหมด
        </h2>
        ...
        >
          ...
          <div class="flex-1 ml-2">
            <div class="flex justify-between">
              ...
              <div>
                <div
                  class="flex justify-center items-center text-xs rounded-[30px] gap-2 w-[45px] h-full text-[#D78D33] bg-[#FFF1E0]"
                >
                  <div>
