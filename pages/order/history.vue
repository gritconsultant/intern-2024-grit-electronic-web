                ...
                <div class="flex justify-between items-center">
                  <div v-if="order.status === 'success'">
                    ...
                    <p class="text-gray-500 text-sm">
                      ...
                      <span class="text-green-600">จัดส่งสำเร็จ</span>
                    </p>
                  </div>
                  <div v-else-if="order.status === 'failed'">
                    ...
                    <span class="text-orange-500 text-sm">ชำระล้มเหลว</span>
                    <span class=" text-sm font-semibold"> : โปรดติดต่อ <span class="font-semibold text-base">Email:BangkokBrand@gmail.com</span></span>
                  </div>
                  <div v-else-if="order.status === 'cancelled'">
                    ...
                    <p class="text-gray-500 text-sm">
                      ...
                      <span class="text-red-500">ยกเลิกคำสั่งซื้อ</span>
                    </p>
                  </div>
            ...
            <div v-if="selectedOrder">
              ...
              <div class="mt-4 pb-4 border-b">
                ...
                <p class="text-gray-500 text-sm mt-2">
                  ...
                  >
                  ตำบล/แขวง:
                  {{ selectedOrder.Shipment?.sub_district }} อำเภอ/เขต:
